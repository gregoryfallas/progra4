<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TiposAviones.aspx.cs" Inherits="Web_Consumo.TiposAviones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Page content-start -->
        ...
        <div runat="server" class="row">
            ...
            <!-- Controls-end -->
            <!-- Table-start -->
            <div id="divTabla" runat="server" class="col-lg-8" style="padding:5px">
