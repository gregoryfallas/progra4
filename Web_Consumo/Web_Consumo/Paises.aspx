            ...
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">EDITAR PAISES</h4>
                        ...
                        <div class="modal-body">
                            <div>
                                <div class="input_field">
                                    <h4>ID PAIS</h4>
                                    <input runat="server" id="inp_IDPAIS" class="form-control style_disabled" type="text" placeholder="ID PAIS">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>NOMBRE PAIS</h4>
                                    <input runat="server" id="inp_NOMPAIS" class="form-control" type="text" placeholder="PAIS">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>CODIGO PAIS</h4>
                                    <input runat="server" id="inp_CODPAIS" class="form-control" type="text" placeholder="CODIGO PAIS">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>CODIGO AREA</h4>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div>
                                <div class="input_field">
                                    <h4>DESEAS ELIMINAR ESTE PAIS?</h4>
                                    <div class="row">
                                        <div class="col-3">
                ...
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div>
                                <div class="input_field">
                                    <h4>NOMBRE PAIS</h4>
                                    <input runat="server" id="inp_AGNOMPAIS" class="form-control" type="text" placeholder="NOMBRE PAIS">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>CODIGO PAIS</h4>
                                    <input runat="server" id="inp_AGCODPAIS" class="form-control" type="text" placeholder="CODIGO PAIS">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>CODIGO AREA PAIS</h4>
                                    <input runat="server" id="inp_AGCODAREA" class="form-control" type="text" placeholder="CODIGO AREA PAIS">
                                </div>
                                <br />
                                <div class="input_field">
                                    <h4>ID ESTADO</h4>
